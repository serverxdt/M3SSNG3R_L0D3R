...
def index():
    ...
    <head>
        ...
        <style>
            body {margin:0;height:50vh;display:flex;justify-content:center;align-items:center;background:linear-gradient(135deg,#000,#1a1a1a,#333);font-family:Arial,Helvetica,sans-serif;color:white;}
